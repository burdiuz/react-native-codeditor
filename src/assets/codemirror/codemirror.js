async function moduleInitFunction(requireAsyncModule,exports={}){const module={exports:exports};var hasRequiredDist,require$$0=await requireAsyncModule("@codemirror/view"),require$$1=await requireAsyncModule("@codemirror/state"),require$$2=await requireAsyncModule("@codemirror/language"),require$$3=await requireAsyncModule("@codemirror/commands"),require$$4=await requireAsyncModule("@codemirror/search"),require$$5=await requireAsyncModule("@codemirror/autocomplete"),require$$6=await requireAsyncModule("@codemirror/lint"),dist={},distExports=function requireDist(){return hasRequiredDist?dist:(hasRequiredDist=1,function(exports){var view=require$$0,state=require$$1,language=require$$2,commands=require$$3,search=require$$4,autocomplete=require$$5,lint=require$$6;// (The superfluous function calls around the list of extensions work
...
/**
		...
		*/Object.defineProperty(exports,"EditorView",{enumerable:!0,get:function(){return view.EditorView}}),exports.basicSetup=basicSetup,exports.minimalSetup=minimalSetup}(dist),dist)}(),index=/*@__PURE__*/function getDefaultExportFromCjs(x){return x}(distExports);return module.exports=index,module.exports}